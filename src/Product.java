...
import java.util.LinkedList; // This is a Built-in Java Collections Framework which is asked to use in program.
...
// It holds the current stock data and a history of recent changes which we made along with just keep last 4 activities of product.
...
public class Product {
    ...
    // and remove old ones from the ends of the list as well as always we add new items from the last of the list.
    ...
    public Product(int Id, String Name, int initialQuantity) {
        ...
        // If we set it to startQty the final value which we get is double i found this bug during testing of my code.
        
        
        this.Productquantity = 0; 

        // Creating the empty list to store activities records.
  ...
  //For eg The getquantity contains the previous value when user add new value it adds in getquantitycount or..             
   ...
   //CUSTOM SORTING ALGORITHM
    ...
    public List<Activity> getSortedRecentActivities() {
        ...
        Activity[] activityArray = this.activities.toArray(new Activity[0]);
        ...
        for (int i = 1; i < activityArray.length; i++) {
            ...
            while (j >= 0 && activityArray[j].getquantitycount() > key.getquantitycount()) {
                
                activityArray[j + 1] = activityArray[j]; // Shift right
                //In this when we did J+1 = activity array at J for eg valuee looks like 50, 50, 70,90. at index 1 we have 
